...
#' protein. The fitter \code{\link{fit_lrmsd_i_msa_ml}} takes the two columns as a
...
#' (\code{fit_lrmsd_n_msa_ml}), keyed by the mode index \code{n}. The fitter takes the
...
#'   \code{data-raw/prepare_znb_data.R}.
#' @seealso \code{\link{fit_lrmsd_n_msa_ml}}, \code{\link{calculate_profiles}}
#' @family datasets
"znb_profile_n"
