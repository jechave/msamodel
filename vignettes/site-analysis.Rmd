...
```{r profile-residue, eval = has_ggplot}
...
```{r profile-lrmsf, eval = has_ggplot}
...
```{r profile-dactive, eval = has_ggplot}
...
```{r fit-vs-lrmsf, eval = has_ggplot}
...
```{r fit-vs-dactive, eval = has_ggplot}
