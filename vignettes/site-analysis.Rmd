...
```r
decomp <- calculate_decomposition(spm, a1, a2, metric = "lrmsd")$site   # a1 = 2, a2 = 500 from section 2
head(decomp)
#> # A tibble: 6 × 9
...
fit_msa <- calculate_decomposition(spm, ml$a1, ml$a2, metric = "lrmsd")$site |>
...
```r
phi_fit <- calculate_decomposition(spm, ml$a1, ml$a2, metric = "lrmsd")$site
```
