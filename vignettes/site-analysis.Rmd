...
`bio3d::read.cif()` for mmCIF — and pass the result to `penm::set_enm()`.
...
The settings above are the ones we use throughout — you can keep them for a first run.
`penm::set_enm()` builds the elastic network (it requires all five arguments, having no
defaults of its own): `node = "ca"` puts one node per residue at its
...
sequence separation between coupled sites. The scan takes a minute or two — it is the
one slow step here. The observed profile we fit to is loaded later, in section 5.
...
#> 1     1       20    -2.60    -2.62    -2.46     -2.55   -2.60  -0.0112 0.0627 
#> 2     2       21    -3.40    -3.61    -3.31     -3.56   -3.40  -0.212  0.0495 
#> 3     3       22    -3.26    -3.34    -3.05     -3.24   -3.26  -0.0780 0.100  
#> 4     4       23    -3.60    -3.75    -3.44     -3.54   -3.60  -0.147  0.208  
#> 5     5       24    -3.69    -4.08    -3.58     -4.08   -3.69  -0.392  0.00719
#> 6     6       25    -3.67    -3.85    -3.56     -3.81   -3.67  -0.180  0.0413
```
...
#> [17] splines_4.2.1      labeling_0.4.3     desc_1.4.3         devtools_2.4.5    
...
#> [33] tidyselect_1.2.1   tibble_3.3.0       viridisLite_0.4.2  crayon_1.5.3      
#> [37] tzdb_0.4.0         withr_3.0.2        later_1.3.2        grid_4.2.1        
#> [41] nlme_3.1-164       xtable_1.8-4       gtable_0.3.6       lifecycle_1.0.4   
#> [45] magrittr_2.0.4     scales_1.4.0       cli_3.6.5          stringi_1.8.3     
#> [49] vroom_1.6.5        cachem_1.0.8       farver_2.1.2       fs_1.6.4          
#> [53] promises_1.2.1     remotes_2.5.0      ellipsis_0.3.2     generics_0.1.4    
#> [57] vctrs_0.6.5        RColorBrewer_1.1-3 tools_4.2.1        bit64_4.0.5       
#> [61] glue_1.8.0         hms_1.1.3          processx_3.8.3     pkgload_1.5.2     
#> [65] parallel_4.2.1     fastmap_1.1.1      sessioninfo_1.2.2  memoise_2.0.1     
#> [69] knitr_1.43         profvis_0.3.8      usethis_2.2.3
```
