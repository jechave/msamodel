...
which selection pressures are switched on. Each is just `calculate_dr2_i_msa()`
...
four model variants above, and the site-level decomposition of section 5. We use
