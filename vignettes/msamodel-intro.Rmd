...
an activity-selection term — built from the model variants of section 4. The
split is *sequential*: starting from the mutation-only model, each term is the
incremental divergence added by turning on the next selection pressure along the
progression M0 → MM → MS → MSA. Writing $\phi$ for the contributions,
