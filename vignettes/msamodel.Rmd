...
later (the [calculate](calculate.html) vignette explains what each controls).
...
be read from any fit; see the [predict](predict.html) vignette.)
...
- **[Calculate](calculate.html)** — the model at parameters you choose: profiles,
...
- **[Predict](predict.html)** — the maximum-likelihood fit to observed data, with
