...
- **[Inference methods](inference-methods.html)** — maximum likelihood is the
  standard fit shown here; `msamodel` also offers a deterministic-posterior fit
  (adaptive Gauss–Hermite quadrature), compared with ML side by side there.
