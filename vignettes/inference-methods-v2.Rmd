...
vignette: >
  %\VignetteIndexEntry{Fitting the model: maximum likelihood with error bands (v2)}
...
for real. The shipped `inference-methods-v2.Rmd` is PRE-RENDERED from this file.
...
vignette exercises (run from INSIDE vignettes/ so fig.path resolves correctly):
  ...
  cd vignettes && Rscript -e 'knitr::knit("inference-methods-v2.Rmd.orig", output = "inference-methods-v2.Rmd")'

then commit this file, the rendered `inference-methods-v2.Rmd`, and its figures.
...
[site analysis](site-analysis-v2.html) and [mode analysis](mode-analysis-v2.html)
...
(the [site analysis](site-analysis-v2.html) vignette covers what they do and how to tune
...
![plot of chunk ml-band](inference-methods-v2_files/figure-html/ml-band-1.png)
...
![plot of chunk ml-nested-plot](inference-methods-v2_files/figure-html/ml-nested-plot-1.png)
...
![plot of chunk ml-decomposition-plot](inference-methods-v2_files/figure-html/ml-decomposition-plot-1.png)
...
[mode analysis](mode-analysis-v2.html) vignette.)
...
![plot of chunk mode-band](inference-methods-v2_files/figure-html/mode-band-1.png)
...
![plot of chunk mode-nested-plot](inference-methods-v2_files/figure-html/mode-nested-plot-1.png)
...
![plot of chunk mode-decomposition-plot](inference-methods-v2_files/figure-html/mode-decomposition-plot-1.png)
...
- **[Site analysis](site-analysis-v2.html)** — the per-residue model in full: predict the
  profile, decompose it, sweep `a1`/`a2`, and fit.
- **[Mode analysis](mode-analysis-v2.html)** — the same arc per normal mode.
- **[Package overview](msamodel-v2.html)** — a short end-to-end tour of both axes.
